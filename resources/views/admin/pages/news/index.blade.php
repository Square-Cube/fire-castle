            ...
            <div class="widget-content">
                <div class="col-sm-12">
                    <div class="add-user-form">
                        <form action="{{route('admin.news')}}" method="post" enctype="multipart/form-data" onsubmit="return false;">
                            {!! csrf_field() !!}
                ...
                <div class="col-sm-12">
                    <div class="table-responsive">
                        <table id="datatableX"  class="table table-hover table-bordered display nowrap" cellspacing="0" width="100%">
                            ...
                            <tr class="ticket-tr">
                                <th>No.</th>
                                <th>news name in english</th>
                                <th>news name in arabic</th>
                                <th>Created at</th>
                                <th>Operations</th>
                            </tr>
                            </thead>
                            ...
                            @foreach($news as $index => $news)
                                <tr class="ticket-tr">
                                    ...
                                    <td>
                                        <a href="{{route('admin.news.edit',['id' => $news->id])}}" class="icon-btn green-bc" title="Edit"> <i class="fa fa-edit"> </i></a>
                                        <a data-url="{{route('admin.news.delete',['id' => $news->id])}}" class="icon-btn red-bc btndelet" title="Delete"><i class="fas fa-trash-alt"> </i></a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
